    ...
    <div class="max-w-xl mx-auto py-8">
        ...
        <form method="POST" action="{{ route('customers.update', $customer) }}">
            ...
            <div class="mb-4">
                ...
                <input id="family_name" name="family_name" type="text" class="block w-full border-gray-300 rounded" value="{{ old('family_name', $customer->family_name) }}" required>
            ...
            <div class="mb-4">
                ...
                <input id="address" name="address" type="text" class="block w-full border-gray-300 rounded" value="{{ old('address', $customer->address) }}" required>
            ...
            <div class="mb-4">
                ...
                <input id="amount_adults" name="amount_adults" type="number" min="0" class="block w-full border-gray-300 rounded" value="{{ old('amount_adults', $customer->amount_adults) }}" required>
            ...
            <div class="mb-4">
                ...
                <input id="amount_children" name="amount_children" type="number" min="0" class="block w-full border-gray-300 rounded" value="{{ old('amount_children', $customer->amount_children) }}">
            ...
            <div class="mb-4">
                ...
                <input id="amount_babies" name="amount_babies" type="number" min="0" class="block w-full border-gray-300 rounded" value="{{ old('amount_babies', $customer->amount_babies) }}">
            ...
            <div class="mb-4">
                ...
                <input id="special_wishes" name="special_wishes" type="text" class="block w-full border-gray-300 rounded" value="{{ old('special_wishes', $customer->special_wishes) }}">
