    ...
    <div class="max-w-xl mx-auto py-8">
        ...
        <form method="POST" action="{{ route('customers.store') }}">
            ...
            <div class="mb-4">
                ...
                <input id="family_name" name="family_name" type="text" class="block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('family_name') }}" required>
            ...
            <div class="mb-4">
                ...
                <input id="address" name="address" type="text" class="block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('address') }}" required>
            ...
            <div class="mb-4">
                ...
                <input id="amount_adults" name="amount_adults" type="number" min="0" class="block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('amount_adults', 1) }}" required>
            ...
            <div class="mb-4">
                ...
                <input id="amount_children" name="amount_children" type="number" min="0" class="block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('amount_children', 0) }}">
            ...
            <div class="mb-4">
                ...
                <input id="amount_babies" name="amount_babies" type="number" min="0" class="block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('amount_babies', 0) }}">
            ...
            <div class="mb-4">
                ...
                <textarea id="special_wishes" name="special_wishes" rows="3" class="block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('special_wishes') }}</textarea>
